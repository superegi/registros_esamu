...
\begin{table}[h]
\centering
\input{../calidad_registros/Tabla1_1.txt}
...
\begin{table}[h]
\centering
\input{../calidad_registros/Tabla1_2.txt}
...
%%% Priorización del REM

\input{../calidad_registros/Resultados2_1.txt}

\begin{table}[h]
\centering
\input{../calidad_registros/Tabla2_1.txt}
\caption{Nombre de los funcionarios que 
son indicados como responsables en REMs no categorizados que tenían indicación de despacho
Se presenta la cantidad de REMs que no cumplen el criterio y el porcentaje de error. Se lista los REM errados para cada uno de ellos.}
\end{table}
